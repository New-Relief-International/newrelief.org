...
//                   />
//                   <div className={`absolute inset-0 bg-gradient-to-t ${event.color} opacity-70`}></div>
...
//                 className="w-full h-full object-cover"
//               />
//               <div className={`absolute inset-0 bg-gradient-to-t ${selectedEvent.color} opacity-80`}></div>
//               <button
//                 onClick={() => setSelectedEvent(null)}
...
//                       <p className="text-sm text-gray-600 mb-3">Prefer to register on Luma directly?</p>
//                       <a
//                         href={selectedEvent.bookingUrl}
//                         target="_blank"
//                         rel="noopener noreferrer"
//                         className="inline-block bg-white border-2 border-gray-300 text-gray-700 px-6 py-3 rounded-xl font-semibold hover:border-gray-400 transition-all"
//                       >
//                         Open in New Tab →
//                       </a>
//                     </div>
