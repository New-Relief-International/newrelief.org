...
// import { Heart, DollarSign, Users, Church, Gift, CheckCircle, XCircle, CreditCard } from 'lucide-react';
...
//   const paystackPublicKey = 'pk_test_xxxxxxxxxxxxxxxxxxxxxxxxxx'; // Replace with your test key

//   const config = {
//     reference: new Date().getTime().toString(),
//     email: formData.email,
//     amount: Math.round(parseFloat(formData.amount || 0) * 100), // Amount in pesewas (GHS lowest unit)
...
//       {/* Error Toast */}
//       {showError && (
//         <div className="fixed top-4 right-4 bg-red-500 text-white px-6 py-4 rounded-lg shadow-lg z-50 flex items-center gap-3 animate-slide-in">
//           <XCircle size={24} />
//           <p>{errorMessage}</p>
//         </div>
//       )}
...
//       {/* Header */}
//       <div className="bg-gradient-to-r from-blue-900 via-purple-900 to-indigo-900 text-white py-20 px-4">
...
//                 <button
//                   type="submit"
//                   className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-xl font-bold text-lg hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
//                 >
//                   Proceed to Payment
//                 </button>
