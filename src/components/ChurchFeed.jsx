...
// export default function ChurchFeed() {
...
//       scripture: "James 2:26 (KJV)",
//       message:
//         "For as the body without the spirit is dead, so faith without works is dead also.",
//       time: "8:45 PM • Oct 26, 2024",
//       views: "105",
//       emoji: "🥽",
//       isFollowing: true,
//     },
...
//       profilePic: "/api/placeholder/48/48",
//       message:
//         "Does anyone remember the scriptures from today’s \"Moment of Wisdom\" with Pastor Emmanuel Arthur? Please share if you do! 👍",
//       time: "9:05 PM • Oct 26, 2024",
//       views: "305",
//       isFollowing: true,
//     },
//     {
...
//       scripture: "Acts 11:26 (KJV)",
//       time: "9:25 PM • Oct 26, 2024",
//       views: "405",
//       emoji: "🩴",
//       isFollowing: true,
//     },
...
//       scripture: "Philippians 2:5-6 (KJV)",
//       time: "7:25 PM • Oct 11, 2024",
//       views: "205",
//       emoji: "🥰",
//       isFollowing: true,
//     },
...
//       scripture: "Exodus 14:14 (KJV)",
//       time: "6:55 PM • Oct 10, 2024",
//       views: "128",
//       isFollowing: false,
//     },
//   ];
...
//             </div>
//             <h1 className="text-2xl font-bold ml-3">New Relief Chats</h1>
//           </div>
//           <button className="bg-white text-gray-800 rounded-full px-4 py-1 text-sm font-medium shadow">
//             About Us
//           </button>
//         </div>
...
//               className={`w-full sm:w-[75%] lg:w-[70%] p-4 rounded-xl shadow-2xl border border-gray-600 backdrop-blur-md bg-white/10 ${
...
//                         {post.name}{post.emoji && <span> {post.emoji}</span>}
//                       </p>
//                       <p className="text-gray-400 text-sm ml-2">{post.username}</p>
//                     </div>
//                     {post.scripture && (
//                       <p className="font-semibold text-blue-200 mt-1">{post.scripture}</p>
//                     )}
...
//                   post.isFollowing ? "bg-gray-200 text-gray-800" : "bg-blue-500 text-white"
//                 }`}>
...
///////////// church feed animation with GSAP ////////////
