...
//         animate="visible"
//       >
//         {/* Saturday Services Card */}
//         <motion.div
//           className="bg-white rounded-lg shadow-md p-6 text-center flex-1 min-w-72 max-w-80 flex flex-col items-center"
...
//             <Clock size={24} />
//           </motion.div>
//           <h2 className="mb-4 text-lg font-bold text-gray-800">Saturday Services</h2>
//           <div className="mb-2">
...
//             <Users size={24} />
//           </motion.div>
//           <h2 className="mb-4 text-lg font-bold text-gray-800">Chapter Meetings</h2>
...
//            <MapPin size={24} />
//           </motion.div>
//           <h2 className="mb-4 text-lg font-bold text-gray-800">Location</h2>
...
////////////////////Info Section with Gsap Animation ////////////////////
