  ...
  return (
    ...
    >
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 flex justify-between items-center">
        {/* Logo */}
        <div ref={logoRef} className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
        ...
        {/* CTA Button */}
        <div ref={ctaRef} className="hidden lg:flex items-center">
          <a
            href="/contact-us"
            className={`rounded-full px-4 xl:px-6 py-2 font-medium transition-all duration-300 transform hover:scale-105 text-sm xl:text-base ${
              scrolled
                ? "bg-blue-600 text-white hover:bg-blue-700 shadow-lg"
                : "bg-white/90 text-blue-800 hover:bg-white shadow-xl"
            }`}
      ...
      {menuOpen && (
        <div className="lg:hidden bg-white/95 backdrop-blur-xl border-t border-gray-200/50 shadow-lg">
          <div className="px-3 sm:px-4 pt-3 pb-4 space-y-1 max-h-[calc(100vh-70px)] overflow-y-auto">
            <MobileNavLink href="/" label="Home" />
            {/* <MobileNavLink href="/about" label="About Us" /> */}
            <MobileNavLink href="/events" label="Events" />
            <MobileNavLink href="/messages" label="Messages" />
            ...
            <div className="pt-4 pb-2 px-1">
              <a
                href="/contact-us"
                className="mobile-menu-item block w-full text-center rounded-lg px-4 py-3 bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors shadow-md active:scale-95 transform duration-150"
              >
                Contact Us
              </a>
            </div>
...
const MobileNavLink = ({ href, label }) => {
  return (
    <a
      href={href}
      className="mobile-menu-item block px-4 py-3 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors active:bg-gray-200"
    >
      {label}
    </a>
  );
