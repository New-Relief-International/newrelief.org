...
//   return (
//     <section ref={sectionRef} className="max-w-7xl mx-auto px-4 py-16 md:py-24">
...
export default function AboutUs() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Less aggressive animations on mobile
      tl.fromTo(
        imageRef.current,
        {
          x: isMobile ? -50 : -200,
  ...
  return (
    <section ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
      <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8 lg:gap-12">
        {/* Image Container with Liquid Glass Effect */}
        <div 
          ref={imageRef}
          className="w-full md:w-1/2 h-64 sm:h-72 md:h-96 lg:h-[28rem]"
        >
          <LiquidGlassImage
            src={heRo2}
            alt="About New Relief"
