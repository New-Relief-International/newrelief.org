...
//         {/* Image Container */}
//         <div className="w-full md:w-1/2 bg-gray-100 rounded-lg overflow-hidden h-72 md:h-96 flex items-center justify-center">
//           <img src= {heRo2} alt="About New Relief" className="object-cover w-full h-full" />
//         </div>
...
//       // Image animation: slide in from left with scale and rotation
//       tl.fromTo(
//         imageRef.current,
//         {
//           x: -200,
...
//       // Additional scroll-based image effects
...
//         <div 
//           ref={imageRef}
//           className="w-full md:w-1/2 bg-gray-100 rounded-lg overflow-hidden h-72 md:h-96 flex items-center justify-center"
//         >
//           <img 
//             src={heRo2} 
