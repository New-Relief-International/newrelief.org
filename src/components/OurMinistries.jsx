...
//           <div key={index} className="border border-gray-200 rounded-lg p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
//             <div className="bg-amber-100 rounded-full w-16 h-16 flex items-center justify-center text-amber-500 mb-4">
//               {ministry.icon}
//             </div>
...
///////////////// Our Ministries with Gsap Animation ////////////////////
